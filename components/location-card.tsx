...
export function LocationCard() {
  ...
  return (
    <motion.div
      ...
      className='card-border relative col-span-4 col-start-1 row-span-3 row-start-2 flex flex-col gap-6 overflow-hidden rounded-xl bg-white p-4 dark:bg-neutral-900 md:col-span-2 md:col-start-1 md:row-span-2 md:row-start-2 md:h-40'
    >
